...
l5 = new loc({
    text:"Чем темнее становится тем более угрожающе выглядит замок, вокруг него прямо на глазах растут камни, кажется будто их тут не должно быть<audio src='files/song9.mp3' autoplay='autoplay'>",
